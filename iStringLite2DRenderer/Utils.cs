...
namespace iStringLite2DRenderer
{
    public static class Utils
    {
        ...
        public static void SoftLoadEffects(out List<Effect> effects, VideoBuffer videoBuffer)
        {
            ...
            //effects.Add(new AnimatedGifEffect("", 0, 0, videoBuffer));
            ...
            effects.Add(new RemoteEffect("/tmp/lol/bmp"));
            // effects.Add(new BitmapEffect("/src/duck.png", 0, 0, videoBuffer)); //50, 20, 20));
